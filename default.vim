...
set noswapfile
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,~/.vim/systags,project_tags
set textwidth=70
...
badd +142 core.cpp
badd +9 core.h
badd +30 pluginloader.cpp
badd +21 pluginloader.h
badd +160 mainwindow.cpp
badd +44 mainwindow.h
badd +44 pluginmanager.cpp
badd +26 pluginmanager.h
badd +1 common.h
badd +5 interfaces/interfaces.h
badd +3 addressparser.cpp
badd +16 addressparser.h
badd +1 tcpsocket.cpp
badd +1 tcpsocket.h
badd +216 tcpimpex.cpp
badd +3 resources.qrc
badd +0 pluginlisttablewidgeticon.cpp
badd +1 plugininfo.cpp
badd +0 plugininfo.h
silent! argdel *
edit main.cpp
...
silent! normal! zE
let s:l = 35 - ((3 * winheight(0) + 10) / 20)
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 17 + 39) / 78)
exe '2resize ' . ((&lines * 57 + 39) / 78)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((16 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 110 - ((39 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((47 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 21 + 39) / 78)
exe '2resize ' . ((&lines * 53 + 39) / 78)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((7 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
exe '1resize ' . ((&lines * 28 + 39) / 78)
exe '2resize ' . ((&lines * 46 + 39) / 78)
tabedit interfaces/interfaces.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
