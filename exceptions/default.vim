...
silent only
cd ~/Programming/xd/src/exceptions
...
badd +1 generic.cpp
badd +1 generic.h
badd +2 notimplemented.cpp
badd +1 notimplemented.h
badd +1 logic.cpp
badd +1 logic.h
badd +1 outofbounds.cpp
badd +35 outofbounds.h
badd +1 help
badd +1 io.cpp
badd +10 io.h
badd +1 exceptions.pro
badd +1 situative.cpp
badd +0 situative.h
silent! argdel *
edit generic.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((27 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
