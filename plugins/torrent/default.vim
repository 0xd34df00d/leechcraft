...
silent only
cd ~/Programming/xd/src/plugins/torrent
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +4 resources.qrc
badd +23 torrent.pro
badd +57 torrentplugin.cpp
badd +37 torrentplugin.h
badd +7 globals.h
badd +1 torrentmanager.cpp
badd +4 torrentmanager.h
badd +121 bencodeparser.cpp
badd +16 bencodeparser.h
badd +22 torrentfileparser.cpp
badd +21 torrentfileparser.h
badd +2 bencodegenerator.cpp
badd +6 bencodegenerator.h
badd +1 addtorrentwidgetitem.cpp
badd +1 addtorrentwidgetitem.h
badd +54 addtorrentdialog.cpp
badd +15 addtorrentdialog.h
badd +0 l
badd +1 torrentclient.cpp
badd +0 torrentclient.h
badd +1 settingsmanager.cpp
badd +0 settingsmanager.h
badd +1 filemanager.cpp
badd +0 filemanager.h
silent! argdel *
edit torrent.pro
...
silent! normal! zE
let s:l = 23 - ((0 * winheight(0) + 20) / 41)
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 24 + 39) / 78)
exe '2resize ' . ((&lines * 50 + 39) / 78)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((15 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 228 - ((35 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
228
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 17 - ((11 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((10 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 18 + 39) / 78)
exe '2resize ' . ((&lines * 56 + 39) / 78)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((10 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 118 - ((51 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((28 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
