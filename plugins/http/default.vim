...
set noswapfile
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,~/.vim/systags,../../project_tags,project_tags
set textwidth=70
...
badd +35 http.pro
badd +2 main.h
badd +32 httpplugin.h
badd +7 httpplugin.cpp
badd +33 jobadderdialog.cpp
badd +10 jobadderdialog.h
badd +1 jobparams.h
badd +6 httpimp.h
badd +7 httimp.cpp
badd +67 job.h
badd +104 job.cpp
badd +110 jobmanager.cpp
badd +24 jobmanager.h
badd +1 JobRepresentation.h
badd +12 jobrepresentation.h
badd +1 joblistitem.cpp
badd +1 joblistitem.h
badd +172 httpimp.cpp
badd +1 addressparser.cpp
badd +1 addressparser.h
badd +1 fileexistsdialog.cpp
badd +1 fileexistsdialog.h
badd +22 finishedjob.cpp
badd +1 finishedjob.h
badd +48 settingsmanager.cpp
badd +61 settingsmanager.h
badd +1 resources.qrc
badd +1 impbase.cpp
badd +0 impbase.h
badd +37 jobparams.cpp
badd +1 ftpimp.cpp
badd +0 ftpimp.h
silent! argdel *
edit httpplugin.h
...
silent! normal! zE
let s:l = 96 - ((21 * winheight(0) + 13) / 27)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 420 - ((46 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
420
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 191 - ((19 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
191
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 19 + 39) / 78)
exe '2resize ' . ((&lines * 55 + 39) / 78)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 90 - ((13 * winheight(0) + 9) / 19)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 74 - ((54 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 95 - ((29 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((17 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((29 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
