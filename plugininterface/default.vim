...
silent only
cd ~/Programming/xd/src/plugininterface
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +13 plugininterface.pro
badd +1 addressparser.h
badd +1 addressparser.cpp
badd +1 proxy.cpp
badd +1 proxy.h
badd +130 tcpsocket.cpp
badd +14 tcpsocket.h
badd +1 filewriter.cpp
badd +1 filewriter.h
badd +1 filewriterthread.cpp
badd +1 filewriterthread.h
badd +3 socketexceptions.cpp
badd +1 socketexceptions.h
silent! argdel *
edit plugininterface.pro
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((26 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 130 - ((27 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
130
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 30 + 39) / 78)
exe '2resize ' . ((&lines * 44 + 39) / 78)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
