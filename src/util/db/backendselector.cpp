...
void BackendSelector::FillUI ()
{
	...
	Ui_->SQLiteVacuum_->setCheckState (Manager_->Property ("SQLiteVacuum", false).toBool () ? Qt::Checked : Qt::Unchecked);
	Ui_->SQLiteJournalMode_->setCurrentIndex (Ui_->SQLiteJournalMode_->findText (Manager_->Property ("SQLiteJournalMode", "TRUNCATE").toString ()));
	Ui_->SQLiteTempStore_->setCurrentIndex (Ui_->SQLiteTempStore_->findText (Manager_->Property ("SQLiteTempStore", "MEMORY").toString ()));
	Ui_->SQLiteSynchronous_->setCurrentIndex (Ui_->SQLiteSynchronous_->findText (Manager_->Property ("SQLiteSynchronous", "OFF").toString ()));
...
void BackendSelector::accept ()
{
	...
	Manager_->setProperty ("SQLiteVacuum", Ui_->SQLiteVacuum_->checkState () == Qt::Checked);
	Manager_->setProperty ("SQLiteJournalMode", Ui_->SQLiteJournalMode_->currentText ());
	Manager_->setProperty ("SQLiteTempStore", Ui_->SQLiteTempStore_->currentText ());
	Manager_->setProperty ("SQLiteSynchronous", Ui_->SQLiteSynchronous_->currentText ());
