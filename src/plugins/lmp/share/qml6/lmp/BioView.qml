    ...
    Image {
        ...
        states: [
            ...
            State {
                ...
                PropertyChanges { target: bioViewBlur; blur: 1 }
                PropertyChanges { target: loadProgress; opacity: 0 }
            }
        ]
        ...
        transitions: Transition {
            ...
            PropertyAnimation { target: bioViewBlur; property: "blur"; duration: 300; easing.type: Easing.OutSine }
        }
