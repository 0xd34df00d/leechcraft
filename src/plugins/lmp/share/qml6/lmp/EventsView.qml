...
Rectangle {
    ...
    Image {
        ...
        states: [
            State {
                ...
                PropertyChanges { target: eventsViewBlur; blur: 0 }
            },
            State {
                name: "visible"
                PropertyChanges { target: fullSizeEventImg; opacity: 1 }
                PropertyChanges { target: eventsViewBlur; blur: 1 }
            }
        ]

        transitions: Transition {
            PropertyAnimation { property: "opacity"; duration: 300; easing.type: Easing.OutSine }
            PropertyAnimation { target: eventsViewBlur; property: "blur"; duration: 300; easing.type: Easing.OutSine }
        }
    ...
    ListView {
        ...
        visible: !eventsViewBlur.visible
