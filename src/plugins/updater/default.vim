...
set shortmess=aoO
badd +15 updater.pro
badd +0 resources.qrc
badd +2 updater.cpp
badd +12 updater.h
badd +1 updaterplugin.h
badd +170 updaterplugin.cpp
badd +7 globals.h
badd +1 settingsmanager.cpp
badd +6 settingsmanager.h
badd +1 core.cpp
badd +0 core.h
silent! argdel *
edit updater.pro
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((36 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 73 - ((22 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 91 - ((24 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
