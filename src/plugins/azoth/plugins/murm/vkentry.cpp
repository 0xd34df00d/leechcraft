	...
	namespace
	{
		void FixEmoji (QString& text)
		{
			const uint32_t knowns []
			{
				...
				0xD83DDEC0,		0xD83CDDE8D83CDDF3,
				0xD83CDDE9D83CDDEA,	0xD83CDDEAD83CDDF8,
				0xD83CDDEBD83CDDF7,	0xD83CDDECD83CDDE7,
				0xD83CDDEED83CDDF9,	0xD83CDDEFD83CDDF5,
				0xD83CDDF0D83CDDF7,	0xD83CDDF7D83CDDFA
			};
