...
Rectangle {
    ...
    Flickable {
        ...
        Image {
            ...
            transitions: Transition {
                ...
                PropertyAnimation { target: photoViewBlur; property: "blur"; duration: 300; easing.type: Easing.OutSine }
            }
    ...
    GridView {
        ...
        visible: listingMode && !photoViewBlur.visible
