...
namespace Fua
{
	...
	void FUA::initPlugin (QObject *proxyObj)
	{
		...
		Browser2ID_ = QList<QPair<QString, QString>>
		{
			...
			{ "Chrome 30.0 (Mac OS X)", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.69 Safari/537.36"},
			...
			{ "Firefox 24.0 (Linux)", "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:24.0) Gecko/20100101 Firefox/24.0"},
			{ "Firefox 24.0 (Windows 7)", "Mozilla/5.0 (Windows NT 6.1; WOW64; rv:24.0) Gecko/20100101 Firefox/24.0"},
			{ "Firefox 24.0 (Mac OS X)", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:24.0) Gecko/20100101 Firefox/24.0"},
			...
			{ "Safari 2 (Mac OS X)", "Mozilla/5.0 (Macintosh; U; PPC Mac OS X; appLanguage) AppleWebKit/412 (KHTML, like Gecko) Safari/412"},
			...
			{ "Safari 6.0 (Mac OS X)", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_5) AppleWebKit/536.30.1 (KHTML, like Gecko) Version/6.0.5 Safari/536.30.1"},
			{ "Safari 7.0 (Mac OS X)", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9) AppleWebKit/537.71 (KHTML, like Gecko) Version/7.0 Safari/537.71"},
