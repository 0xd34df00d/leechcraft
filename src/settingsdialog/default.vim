...
silent only
cd ~/Programming/xd/src/settingsdialog
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 settingsdialog.h
badd +1 settingsdialog.cpp
badd +1 settingsdialog.pro
badd +1 typehandler.cpp
badd +1 typehandler.h
badd +11 settingsiteminfo.h
badd +1 converters.h
badd +0 converters.cpp
silent! argdel *
edit settingsdialog.h
